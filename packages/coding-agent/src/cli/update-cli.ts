...
import { $env, $which, APP_NAME, isEnoent, VERSION, WhichCachePolicy } from "@oh-my-pi/pi-utils";
import { $ } from "bun";
...
export function resolveReleaseBinaryAsset(
	...
	const expectedUrl = buildBinaryDownloadUrl(repo, expectedTag, binaryName);
